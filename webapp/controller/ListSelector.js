﻿sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("git.zkeren_git.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias git.zkeren_git.controller.ListSelector
			 */
			 ...
			 * @return {git.zkeren_git.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
