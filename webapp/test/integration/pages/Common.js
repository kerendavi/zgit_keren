sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("git/zkeren_git/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("git.zkeren_git.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["git/zkeren_git/localService/mockserver"], function (mockserver) {
